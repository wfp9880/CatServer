...
{    
    ...
    u_char  errstr[NGX_MAX_ERROR_STR+1]; //2048  -- ************  +1是我自己填的，防止结尾\0错误
    u_char  *p,*last;
    ...
    *p++ = '\n'; //增加个换行符    
    ...
    //往标准错误【一般是屏幕】输出信息    
    write(STDERR_FILENO,errstr,p - errstr); //标准错误，一般指屏幕
...
u_char *ngx_log_errno(u_char *buf, u_char *last, int err)
{
    ...
    {
        //保证整个我装得下，我就装，否则我全部抛弃 ,另一个做法是 如果位置不够，就硬留出50个位置【哪怕覆盖掉以往的有效内容】，也要硬往后边塞，这样当然也可以；
